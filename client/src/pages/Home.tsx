    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-3xl font-bold text-center mb-12">Why Choose PotatoGuard?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-accent p-6 rounded-lg">
                ...
                <p className="text-neutral-darkest">Our CNN-based AI model is trained on thousands of leaf images for reliable disease identification.</p>
              </div>
              ...
              <div className="bg-accent p-6 rounded-lg">
                ...
                <p className="text-neutral-darkest">Get disease identification and treatment recommendations in seconds, not days.</p>
              </div>
              ...
              <div className="bg-accent p-6 rounded-lg">
                ...
                <p className="text-neutral-darkest">Receive detailed treatment recommendations and prevention strategies for each disease.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-accent">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg mb-8">Start analyzing your potato leaves today and take proactive steps to prevent crop loss.</p>
              <Link href="/analyzer">
